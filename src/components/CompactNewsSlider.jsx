        ...
        <div className="px-4 lg:px-20 xl:px-32 2xl:px-48">
          ...
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center gap-2">
                <div className="w-2 h-6 md:h-8 bg-yellow-400 rounded-full shadow-[0_0_10px_rgba(250,204,21,0.8)]"></div>
            ...
            <Link href="/latest-news" className="text-[10px] md:text-xs font-bold text-yellow-400 hover:text-yellow-300 uppercase tracking-wider flex items-center gap-1 drop-shadow-[0_0_8px_rgba(250,204,21,0.6)] transition-all">
              ...
              {displayNews.map((item) => {
                ...
                return (
                  <Link 
                    ...
                    className="group no-underline flex flex-col snap-start shrink-0 w-[calc(80%-16px)] sm:w-[calc(50%-12px)] lg:w-[calc(25%-18px)] bg-[#141414] rounded-2xl border border-white/10 overflow-hidden transition-all duration-300 hover:-translate-y-2 hover:border-yellow-400 hover:shadow-[0_0_25px_rgba(250,204,21,0.4)] relative"
                  >
                    {/* Glowing Accent Line at the top of the card on hover */}
                    <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-yellow-400 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-20"></div>
                    ...
                    <div className="w-full aspect-[16/9] bg-black relative overflow-hidden">
                        ...
                        <div className="absolute top-3 left-3 flex gap-2 z-10">
                            {item.isBreaking ? (
                              ...
                              <div className="bg-black/80 border border-white/20 text-yellow-400 text-[10px] font-black px-2.5 py-1 rounded shadow-lg uppercase tracking-widest backdrop-blur-md">
                                  NEWS
                              </div>
                            )}
                        </div>
                    ...
                    <div className="p-4 md:p-5 flex flex-col flex-1 bg-gradient-to-b from-[#141414] to-[#0a0a0a]">
                        ...
                        <div className="flex items-center gap-2 mt-auto pt-4 text-gray-400 text-[11px] md:text-[12px] font-medium">
                            <i className="far fa-clock text-yellow-400 opacity-80"></i>
                            <span>{timeStr}</span>
                        </div>
                    </div>
                  </Link>
