import Component from '@/old_pages/ActorDetail';
...
export async function generateMetadata({ params }) {
    ...
    try {
        const res = await api.get(`/seo/metadata?url=/${'actor'}/${id}`);
        if (res.data) {
            return {
                ...
                alternates: {
                    canonical: res.data.canonical || `https://pbtadka.com/${'actor'}/${id}`
                },
                openGraph: {
                    title: res.data.title,
                    description: res.data.description,
                    url: res.data.canonical || `https://pbtadka.com/${'actor'}/${id}`,
