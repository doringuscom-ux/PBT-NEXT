import Component from '@/old_pages/VideoDetail';
...
export async function generateMetadata({ params }) {
    ...
    try {
        const res = await api.get(`/seo/metadata?url=/${'latest-viral-videos'}/${id}`);
        if (res.data) {
            return {
                ...
                alternates: {
                    canonical: res.data.canonical || `https://pbtadka.com/${'latest-viral-videos'}/${id}`
                },
                openGraph: {
                    title: res.data.title,
                    description: res.data.description,
                    url: res.data.canonical || `https://pbtadka.com/${'latest-viral-videos'}/${id}`,
