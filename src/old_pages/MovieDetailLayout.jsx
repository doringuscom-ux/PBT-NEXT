                                ...
                                <section>
                                    ...
                                    <div className="bg-white p-10 rounded-[2.5rem] shadow-[0_10px_40px_rgba(0,0,0,0.03)] border border-gray-100 overflow-hidden relative">
                                        ...
                                        <div className="relative z-10">
                                            ...
                                            {movie.fullStory && (
                                                <AutoLinker 
                                                     className="mt-12 pt-12 border-t border-dashed border-gray-200 rich-text-content prose prose-slate max-w-none text-slate-600 font-medium" 
                    ...
                    <aside className="lg:w-[35%] xl:w-[35%] relative">
                        <div className="sticky top-[140px] h-[calc(100vh-160px)] overflow-y-auto no-scrollbar pb-6 space-y-8 pr-2">
                            <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
                                ...
                                <Link href="/latest-movies" className="block w-full text-center mt-8 py-3 rounded-xl border-2 border-slate-100 text-[10px] font-black uppercase tracking-widest text-slate-600 hover:bg-slate-50 transition-colors">View All Movies</Link>
                            </div>
                        </div>
                    </aside>
                </div>
